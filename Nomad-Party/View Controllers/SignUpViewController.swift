...
class SignUpViewController: UIViewController {
    ...
    // UI Elements corresponding to SignUpViewController
    ...
    @IBAction func dismissAction(_ sender: Any) {
        ...
        // Takes user back to previous screen. Corresponds with the "Back" button.
        navigationController?.popViewController(animated: true)
        
    }
    
    
    // Signs user up by adding them in Firebase. Monitors their location and online status. 
