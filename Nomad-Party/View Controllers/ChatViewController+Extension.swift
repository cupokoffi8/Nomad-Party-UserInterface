...
extension ChatViewController {
    ...
    // Image picker to select photos to send
    func setupPicker() {
    ...
    // Sets up UI to allow user to send photo or audio message
    ...
    // Adjusts message input view container with the on screen keyboard
...
//                self.observeActivity()
    ...
    // Status function wasn't working. The top label shows the user who the messages are sent to.
